#!/bin/bash
# Bash script to assist in data wrangling, for Mac
# Updated 2018-11
# Saul Lee
# 
reshuffle()
{
	...
	# on Macs, OSX does not come with shuf function
	# use homebrew to install coreutils, shuf is included as gshuf

	echo "Shuffling data"
	gshuf temp_no_header.csv --random-source=<(get_seeded_random $random_seed) > temp_shuffled.csv
